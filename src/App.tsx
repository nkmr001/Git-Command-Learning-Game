...
export const gitCommands: GitCommand[] = [
  ...
  // ... 他のコマンドも同様に更新が必要ですが、まずは主要なものでパターンを示します
  // ユーザーの要望「テーマのコマンドを含む複数のコマンドを使って」に対応するため、
  // 以前の単純なリストから、ストーリー性のあるタスクに変更しました。
  // 残りのコマンドも同様のパターンで実装します。
  {
    id: 'clone',
    name: 'git clone',
    category: '基本',
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100">
      ...
      <main className="max-w-7xl mx-auto px-4 py-8 sm:px-6 lg:px-8">
        {viewMode === 'list' && (
          <Tabs value={activeTab} onValueChange={(v) => setActiveTab(v as 'basic' | 'advanced' | 'terminal')}>
            <TabsList className="grid w-full max-w-2xl mx-auto grid-cols-3 mb-8">
              <TabsTrigger value="basic">基本コマンド</TabsTrigger>
              <TabsTrigger value="advanced">上級クイズ</TabsTrigger>
